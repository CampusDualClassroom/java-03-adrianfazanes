...
public class Exercise03 {
    ...
    public static void checkUser(String user, String pass) {
        if (user.equals("Sebas") && pass.equals("sebas01")){
            ...
            System.out.println(error("Sebas")); // Aqui si pongo user no funciona
    ...
    public static void main(String[] args) {
        checkUser("Sebas", "sebas01"); // Mensaje de bienvenida

        checkUser("Sebas", "rfregeg"); // Mensaje de bienvenida
    }
}
